// Custom glossary entries for a computer science thesis
#let glossary-entries = (
  (
    key: "glossllm",
    short: "LLM",
    long: "Modelos de Lenguaje a Gran Escala",
    description: "Modelos de lenguaje entrenados con grandes cantidades de datos y parámetros, capaces de generar texto coherente y realizar tareas de procesamiento del lenguaje natural.",
  ),
  (
    key: "glossgdpr",
    short: "GDPR",
  ...
  (
    ...
    description: "Disciplina científica que se ocupa de crear programas informáticos que ejecutan operaciones comparables a las que realiza la mente humana, como el aprendizaje o el razonamiento lógico.",
  ),
  (
    key: "glosswww",
    short: "WWW",
    long: "World Wide Web",
    description: "Sistema de distribución de documentos de hipertexto interconectados y accesibles a través de Internet mediante un navegador web.",
  ),
  (
    key: "glossxml",
    short: "XML",
  ...
  (
    key: "glossjson",
    short: "JSON",
    long: "Notación de Objetos de JavaScript",
    description: "Formato de texto sencillo para el intercambio de datos."
  ),
  (
    key: "glossrest",
    short: "REST",
  ...
  (
    key: "glosssse",
    short: "SSE",
    long: "Eventos Enviados por el Servidor",
    description: "Tecnología web que permite a un servidor enviar actualizaciones automáticas e información en tiempo real a un navegador web a través de una conexión HTTP estándar."
  ),
  (
    key: "glosshttp",
    short: "HTTP",
  ...
  (
    key: "glossfoss",
    short: "FOSS",
    long: "Software Libre y de Código Abierto",
    description: "Programa informático cuyo código fuente es público y accesible, permitiendo a cualquier usuario ejecutarlo, estudiarlo, modificarlo y distribuirlo libremente."
  ),
  (
    key: "glosslopdgdd",
    short: "LOPDGDD",
  ...
  (
    key: "glosswow",
    short: "WoW",
    long: "Modelo de Trabajo",
    description: "Conjunto de principios, metodologías y prácticas que un equipo o una organización adopta para llevar a cabo su trabajo de manera eficiente y efectiva."
  ),
  (
    key: "glosspymes",
    short: "PYMES",
  ...
  (
    key: "glossieee",
    short: "IEEE",
    long: "Instituto de Ingenieros Eléctricos y Electrónicos",
    description: "Organización profesional dedicada a promover el desarrollo y aplicación de tecnologías de la información y la comunicación."
  ),
  (
    key: "glosswcag",
    short: "WCAG",
    long: "Directrices de Accesibilidad para el Contenido Web",
    description: "Normas internacionales para garantizar que el contenido web sea accesible para personas con discapacidad."
  ),
  (
    key: "glossuml",
    short: "UML",
