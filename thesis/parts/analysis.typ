...
#[
  ...
  #figure(
    table(
      ...
      [REQ-SW-FC-01 <REQ-SW-FC-01>],
      [
        Carácter: Conveniente. \
        Prioridad: Media. \
        Estado: Viable. \
        Verificabilidad: Media. \
        Origen: REQ-US-NF-01 y \ REQ-US-NF-03.
      ],
...
#[
  ...
  #figure(
    table(
      ...
      [El _software_ debe desarrollarse sin vulnerabilidades de severidad alta en las dependencias, comprobadas con herramientas de auditoría, en concordancia con el objetivo O5 de la @sec:objetivos.],
      
      [REQ-SW-NF-03 <REQ-SW-NF-03>],
      [
        Carácter: Conveniente. \
        Prioridad: Media. \
        Estado: Incluido. \
        Verificabilidad: Alta. \
        Origen: REQ-US-FC-01 y \ REQ-US-FC-03.
      ],
